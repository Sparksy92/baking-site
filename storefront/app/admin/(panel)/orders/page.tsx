          ...
          <tbody className="divide-y divide-gray-100">
            {orders.map((order) => (
              <tr key={order.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3"><span className="capitalize px-2 py-0.5 bg-gray-100 rounded text-xs font-medium">{order.status}</span></td>
                <td className="px-4 py-3"><span className="capitalize px-2 py-0.5 bg-gray-100 rounded text-xs font-medium">{order.payment_status}</span></td>
