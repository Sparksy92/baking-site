    ...
    <div className="min-h-screen bg-gray-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10">
          {!searched && (
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">What are you looking for?</h1>
          )}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
              <p className="text-base text-gray-600">
                {loading ? (
                  ...
                  total === 0 ? `No products found for "${query}"` : <span className="font-medium text-gray-900">{total} result{total !== 1 ? 's' : ''} <span className="text-gray-500 font-normal">for "{query}"</span></span>
                )}
              </p>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  We couldn't find anything matching "{query}". Try adjusting your search terms or browsing our categories.
                </p>
              </div>
            )}
          </div>
