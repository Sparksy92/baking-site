    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      {error ? (
        ...
        <>
          ...
          {/* Payment info */}
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 mb-4 flex items-center justify-between text-sm">
            <span className="text-gray-500">Payment</span>
            <div className="flex items-center gap-2">
              <span className="capitalize text-gray-900 font-medium">
                {order.payment_method === 'etransfer' ? 'Interac e-Transfer' : order.payment_method === 'stripe' ? 'Credit Card' : order.payment_method}
              </span>
