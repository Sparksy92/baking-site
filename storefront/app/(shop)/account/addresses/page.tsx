...
export default function AddressesPage() {
  ...
  function resetForm() {
    setLabel('Home'); setFirstName(''); setLastName('');
    setLine1(''); setLine2(''); setCity('');
    setProvince(''); setPostalCode(''); setPhone('');
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-gray-50 rounded-xl p-5 mb-6 space-y-3">
          ...
          <div>
            ...
            <input type="text" value={line1} onChange={(e) => setLine1(e.target.value)} required className={inputClass} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="text" value={postalCode} onChange={(e) => setPostalCode(e.target.value)} required className={inputClass} />
            </div>
            <div>
