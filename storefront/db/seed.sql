-- Seed default Sage & Sweetgrass categories
...
('payment_instructions', 'Payments are accepted via E-transfer to kirstinsparks@hotmail.com. Once your request is reviewed, we will email you the total and confirmation. Payment is required to secure your baking slot.'),
