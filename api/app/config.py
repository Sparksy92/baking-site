...
class Settings(BaseSettings):
    ...
    # ── Payments ──────────────────────────────────────────────────
    etransfer_email: str = "payments@theartisanbakery.test"
    ...
    # ── Email (Resend) ───────────────────────────────────────────
    resend_api_key: str = ""
    email_from: str = "The Artisan Bakery <orders@sageandsweetgrass.ca>"
    contact_email: str = "hello@theartisanbakery.test"
