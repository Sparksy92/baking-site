...
CREATE TABLE IF NOT EXISTS linkinbio_pages (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS linkinbio_links (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS platform_variations (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS rss_items_posted (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS publish_retries (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_publish_retries_post ON publish_retries(post_id);
CREATE INDEX IF NOT EXISTS idx_publish_retries_pending ON publish_retries(status, scheduled_at);
...
CREATE INDEX IF NOT EXISTS idx_content_library_approved ON content_library(is_approved, times_used, max_uses);
CREATE INDEX IF NOT EXISTS idx_content_library_usage_content ON content_library_usage(library_content_id);
CREATE INDEX IF NOT EXISTS idx_content_library_usage_post ON content_library_usage(social_post_id);

CREATE INDEX IF NOT EXISTS idx_linkinbio_slug ON linkinbio_pages(slug);
CREATE INDEX IF NOT EXISTS idx_linkinbio_active ON linkinbio_pages(is_active);
CREATE INDEX IF NOT EXISTS idx_linkinbio_links_page ON linkinbio_links(page_id);
CREATE INDEX IF NOT EXISTS idx_linkinbio_links_order ON linkinbio_links(page_id, display_order);

CREATE INDEX IF NOT EXISTS idx_social_conv_platform ON social_conversations(platform, platform_user_id);
CREATE INDEX IF NOT EXISTS idx_social_conv_status ON social_conversations(status, unread_count);
CREATE INDEX IF NOT EXISTS idx_social_conv_assigned ON social_conversations(assigned_to);
CREATE INDEX IF NOT EXISTS idx_social_messages_conv ON social_messages(conversation_id, sent_at);
CREATE INDEX IF NOT EXISTS idx_social_messages_unread ON social_messages(is_read, direction);

CREATE INDEX IF NOT EXISTS idx_platform_var_base ON platform_variations(base_post_id);
CREATE INDEX IF NOT EXISTS idx_platform_var_platform ON platform_variations(platform, status);

CREATE INDEX IF NOT EXISTS idx_rss_feeds_active ON rss_feeds(is_active);
CREATE INDEX IF NOT EXISTS idx_rss_items_feed ON rss_items_posted(feed_id);
CREATE INDEX IF NOT EXISTS idx_rss_items_guid ON rss_items_posted(feed_id, guid);
